...
y=7
# You need to have the ready-made file 'alpha{y-1}.mat' after MEP iteration.
alphamat = loadmat(f'alpha{y-1}.mat')
alpha = alphamat['alpha']
# temp = alpha - (-0.2)
# temp *= 0.5
# alpha = -0.2 + temp
# savemat(f'alpha{y-1}.mat', {'alpha': alpha})
