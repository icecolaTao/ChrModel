...
Vs = 4 * eps1 * (sigma1) ** 6  # for special pairs TFs and e/p
Ws = 4 * eps1 * (sigma1) ** 12  # for special pairs TFs and e/p
...
TF    EN      1        {Vs:.6E}    {Ws:.6E}  ;sigma=0.6, eps1={eps1}
TF    PR      1        {Vs:.6E}    {Ws:.6E}  ;sigma=0.6, eps1
EN    PR      1        {Vs:.6E}    {Ws:.6E}  ;sigma=0.6, eps1
"""
...
pairs = """
[ pairs ]
;ai     aj       func          V(soft-core)             W(pre-factor of MEP)
"""
for i in range(101, 433):
    for j in range(i + 1, 434):
        if i in [243, 244, 245, 246, 247, 248, 249] and j in [283, 284, 285, 286, 287, 288, 289]:
            pairs += "{:>3}\t{:>3}\t{:>5}\t{:>18.6E}\t{:>18.6E}\n".format(
                i, j, 1, 1, -0.07)
            count += 1
        elif j % 2 == 0:
            pairs += "{:>3}\t{:>3}\t{:>5}\t{:>18.6E}\t{:>18.6E}\n".format(
